...
export default function SecondHoodie() {
    const [hoodie, setHoodie] = useState(0);
    const [click, setClick] = useState(true);
    const colors = ['Blue', 'Gray']
    const urls = ['https://buy.stripe.com/8wMdTDdAweHcaqY00d', 'https://buy.stripe.com/8wM02N9kg9mS8iQ9AM']
    return (
                ...
                <Row>
                    <Col sm={3} xs={3} style={{maxWidth: '150px', overflow: 'scroll', maxHeight: '90vh'}}>
                        <Row style={{overflow: 'visible'}}>
                            <Nav.Link eventKey="first"><Image src={`/${colors[hoodie]}HoodieFront2.jpg`}
                                                              style={{width: '100%'}}/></Nav.Link>
                        </Row>
                        <Row style={{overflow: 'visible'}}>
                            <Nav.Link eventKey="second"><Image src={`/${colors[hoodie]}HoodieBack2.jpg`}
                                                               style={{width: '100%'}}/></Nav.Link>
                        </Row>
                    </Col>
                    <Col lg={6} xs={9} style={{maxHeight: '600px'}}>
                        <Tab.Content>
                            <Tab.Pane eventKey="first"><Container><Image style={{width: '100%'}}
                                                                         src={`/${colors[hoodie]}HoodieFront2.jpg`}/></Container></Tab.Pane>
                            <Tab.Pane eventKey="second"><Container><Image style={{width: '100%'}}
                                                                          src={`/${colors[hoodie]}HoodieBack2.jpg`}/></Container></Tab.Pane>
                        </Tab.Content>
                    </Col>
                    <Col lg={3} xs={12}>
                        <h1>Qu&apos;ran 31:17 Hoodie</h1>
                        <Col>
                            <Row>
                                <h3>Ratings</h3>
                                            ...
                                            <Container style={{border: '1px solid grey', borderRadius: '5px'}}>
                                                <a className={'color-change'} onClick={() => setHoodie(0)}>
                                                    <Image
                                                        ...
                                                        src={'/BlueHoodieFront2.jpg'}/>
                                                    <p style={{color: 'black', margin: 0}}>Royal Blue</p>
                                                </a>
                                            </Container>
                                        </Col>
                                        <Col style={{padding: '10px'}}>
                                            <Container onMouseOver={() => setHoodie(1)}
                                                ...
                                                <a className={'color-change'} onClick={() => setClick(false)}>
                                                    <Image
                                                        style={{display: 'block', maxHeight: '100%', maxWidth: '100%'}}
                                                        src={'/GrayHoodieFront2.jpg'}/>
                                                    <p style={{color: 'black', margin: 0}}>Charcoal</p>
                                                </a>
                                            </Container>
                                        </Col>
                                    </>
