...
export default function SixthHoodie() {
    const [hoodie, setHoodie] = useState(0);
    const [click, setClick] = useState(true);
    const colors = ["Brown", "Red"];
    const urls = ['https://buy.stripe.com/6oE3eZ68456C42A6oN', 'https://buy.stripe.com/3cseXH8gcgPk56E4gE']
    return (
                ...
                <Row>
                    <Col sm={3} xs={3} style={{maxWidth: '150px', overflow: 'scroll', maxHeight: '90vh'}}>
                        <Row style={{overflow: 'visible'}}>
                            <Nav.Link eventKey="first"><Image src={`/${colors[hoodie]}HoodieFront6.jpg`}
                                                              style={{width: '100%'}}/></Nav.Link>
                        </Row>
                        <Row style={{overflow: 'visible'}}>
                            <Nav.Link eventKey="second"><Image src={`/${colors[hoodie]}HoodieBack6.jpg`}
                                                               style={{width: '100%'}}/></Nav.Link>
                        </Row>
                    </Col>
                    <Col lg={6} xs={9} style={{maxHeight: '600px'}}>
                        <Tab.Content>
                            <Tab.Pane eventKey="first"><Container><Image style={{width: '100%'}}
                                                                         src={`/${colors[hoodie]}HoodieFront6.jpg`}/></Container></Tab.Pane>
                            <Tab.Pane eventKey="second"><Container><Image style={{width: '100%'}}
                                                                          src={`/${colors[hoodie]}HoodieBack6.jpg`}/></Container></Tab.Pane>
                        </Tab.Content>
                    </Col>
                    <Col lg={3} xs={12}>
                        <h1>Pyramid Hoodie</h1>
                        <Col>
                            <Row>
                                <h3>Ratings</h3>
                                            ...
                                            <Container style={{border: '1px solid grey', borderRadius: '5px'}}>
                                                <a className={'color-change'} onClick={() => setHoodie(0)}>
                                                    <Image
                                                        ...
                                                        src={`/${colors[0]}HoodieFront6.jpg`}/>
                                                    <p style={{color: 'black', margin: 0}}>Burgundy</p>
                                                </a>
                                            </Container>
                                        </Col>
